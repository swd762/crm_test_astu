            ...
            <table class="w-full whitespace-nowrap">
                ...
                <tr v-for="meter in meters.data" :key="meter.id" class="hover:bg-gray-100 focus-within:bg-gray-100">
                    ...
                    <td class="border-t w-px">
                        <inertia-link class="flex items-center" :href="bills" tabindex="-1">
                            <span class="px-6 py-4 flex items-center">счет</span>
    ...
    watch: {
        form: {
            ...
            handler: throttle(function () {
                this.$inertia.get(this.route('abonent.meters'), pickBy(this.form), {preserveState: true})
            }, 150),
        },
    },
    methods: {
